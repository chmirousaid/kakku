          ...
          <div class="flex items-center">
            ...
            <div class="hidden md:block">
              <div class="ml-10 flex items-baseline space-x-4">
                ...
                <a href="/" class="rounded-md bg-gray-900 px-3 py-2 text-sm font-medium text-white" style="" aria-current="page">Koti</a>
                <a href="/Tarina"
                  class="rounded-md px-3 py-2 text-sm font-medium text-white-300 hover:bg-gray-700 hover:text-white"
                  aria-current="page">Tarina</a>
                <a href="/Reseptit"
                  class="rounded-md px-3 py-2 text-sm font-medium text-white-300 hover:bg-gray-700 hover:text-white">Reseptit</a>
